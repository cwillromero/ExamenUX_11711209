    ...
    <nav>
        ...
        <div id="NavBar" class="nav-wrapper grey darken-2" >
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="perfil.html"><i class="material-icons left">account_box</i>{{ nombre }}</a></li>
            </ul>
        </div>
    </nav> 
    `
    ...
    <footer class="page-footer grey darken-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col s3"><a class="grey-text text-lighten-3" href="perfil.html"><i class="material-icons left">account_box</i>Perfil</a></div>
            </div>            
          </div>
